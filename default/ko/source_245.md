...
Transcribe the title in its entirety. Do not abbreviate. Repeated letters indicated by a macron diacritic may be written out: m[m] Indicate line breaks with **\|** (the vertical pipe) with a single space before and after. Each character that is written in superscript must be preceded by a \|, as in: 1\|m\|o . Each character that is written in superscript must be preceded by a \|, as in: 1\|m\|o . Indicate line breaks with **\|** (the vertical pipe) with a single space before and after.
