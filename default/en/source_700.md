...
Enter all additional personal names that appear on the source as well as names that can be inferred. This field is linked to the **Personal names** authority file through $0 and life dates are displayed in $d. Names
not yet in the authority file may be added. Do not use **Anonymus** in this field.
...
works in the collection. Enter names associated with individual works in the child records.
