...
Istnieją dwa sposoby tworzenia folderów. Z strony wyszukiwania wybierz rekordy, zaznaczając pole po lewej stronie obok każdego rekordu. W **Działania wsadowe** powyżej listy rekordów po lewej stronie, kliknij **Utwórz folder z pozycjami**. Nazwij folder i kliknij przycisk **OK.** Z przycisku **Działania zbiorcze** możesz również dodać rekordy do już istniejącego folderu. This method enables up to 1,000 records (the maximum number of results on a search page) to be added to a new or existing folder. Wybór rekordów jest zachowany tylko na bieżącej stronie wyników.
