...
Należy spisywać tytuł w całości. Nie należy używać skrótów. Należy wskazać znaki zapisane w indeksie górnym używając **\|** bez spacji przed każdym znakiem zapisanym w indeksie górnym. Każdy znak zapisany w indeksie górnym należy poprzedzić znakiem \|, tak jak w: 1\|m\|o. Each character that is written in superscript must be preceded by a \|, as in: 1\|m\|o . Każdy znak zapisany w indeksie górnym należy poprzedzić znakiem \|, tak jak w: 1\|m\|o. Each character that is written in superscript must be preceded by a \|, as in: 1\|m\|o . Należy wskazać koniec linii za pomocą **\|** (kreska pionowa) z pojedynczą spacją przed i po.
