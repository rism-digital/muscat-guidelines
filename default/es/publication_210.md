...
Publications that contain the term _thematic catalog_ in their titles are often catalogs of works but may occasionally touch on other topics or not be extensive in their scope. Compruébelo siempre dos veces. If it’s the former, give it a short title as for a catalog of works. Si es el segundo caso, póngale un título breve del mismo modo que para la bibliografía normal. In short, anything that isn’t a catalog of works is assigned a literature short title.
