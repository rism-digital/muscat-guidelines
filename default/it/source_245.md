...
Transcribe the title in its entirety. Do not abbreviate. Indicate superscripts with **\|** without a space before each superscript sign. Each character that is written in superscript must be preceded by a \|, as in: 1\|m\|o . Repeated letters indicated by a macron diacritic may be written out: m[m] Indicate line breaks with **\|** (the vertical pipe) with a single space before and after.
