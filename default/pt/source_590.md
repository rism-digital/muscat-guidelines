...
- Example: **tr 1 and 2** Example: **tr 1 and 2** Example: **tr 1 and 2** If a part contains the music for multiple instruments, use **and**.
...
- Example: **tr 1 and 2** Example: **tr 1 and 2** If a part contains the music for multiple instruments, use **and**. Example: **tr 1 and 2** Example: **tr 1 and 2** Example: **tr 1 and 2** If a part contains the music for multiple instruments, use **and**.
